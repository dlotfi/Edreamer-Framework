...
namespace Edreamer.Framework.Helpers
{
    ...
    public class ThrowEvaluation
    {
        ...
        [DebuggerStepThrough]
        public void A<TException>(Func<TException, Exception> modifier, string message, Exception innerException, params object[] args)
        ...
        /// <param name="args">An object array of other parameters <see cref="TException"/> type constructor accepts.</param>
        [DebuggerStepThrough]
        public void A<TException>(Func<TException, Exception> modifier, string message, params object[] args)
            where TException : Exception
        {
            if (_throwException)
            {
        ...
        /// <param name="args">An object array of other parameters <see cref="TException"/> type constructor accepts.</param>
        [DebuggerStepThrough]
        public void A<TException>(string message, Exception innerException, params object[] args)
            where TException : Exception
        {
            A((Func<TException, Exception>)null, message, innerException, args);
        }
        ...
        public void A<TException>(string message, params object[] args)
            where TException : Exception
        {
            A((Func<TException, Exception>)null, message, args);
        }
